//
//  AuthorPickerViewController.swift
//  Introduction-to-Storyboards
//
//  Created by John Law on 22/4/2016.
//  Copyright © 2016 Chi Hon Law. All rights reserved.
//

import UIKit

class AuthorPickerViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if indexPath.row == selectedAuthorIndex {
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if let index = selectedAuthorIndex {
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "SaveSelectedAuthor" {
